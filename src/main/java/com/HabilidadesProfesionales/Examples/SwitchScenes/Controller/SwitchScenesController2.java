...
public class SwitchScenesController2 {
    ...
    /**
     * Cambia a Scene1.fxml cuando se dispara un evento (ej: click de botÃ³n).
     */
    public void switchToScene1(ActionEvent event) throws IOException {

        // 1) Ubicamos el archivo FXML dentro de src/main/resources
        //    Ruta absoluta en resources: /Examples/SwitchScenes/View/Scene1.fxml
        URL fxmlLocation = getClass().getResource("/Examples/SwitchScenes/View/Scene1.fxml");

        // Si la ruta estÃ¡ mal, esto evita un NullPointerException con un mensaje claro
        if (fxmlLocation == null) {
            throw new IOException("No se encontrÃ³ el" +
                    " FXML: /Examples/SwitchScenes/View/Scene1.fxml");
        }
